...
namespace CreativeMode
{
    public class VlcMediaPlayerBehaviour : MonoBehaviour
    {
        ...
        {
            get => currentPosition;
            set => vlcPlayer?.SetTime(Mathf.FloorToInt(value * 1000f));
        }

        public float AudioSourcePosition => source.time;
        ...
        public void Play()
        {
            ...
            if(vlcPlayer.State == VLCState.Stopped || 
               vlcPlayer.State == VLCState.Ended)
        ...
        private void InitVlc()
        {
            ...
            vlcLib = new LibVLC("--no-osd", "--verbose=2", "--input-repeat=0");
        ...
        private Media CreateMedia(string url, string audioUrl = null)
        {
            ...
            var media = new Media(vlcLib, new Uri(url), "input-repeat=0");
        ...
        private void OnVlcFlushAudio(IntPtr data, long pts)
        {
            ...
            if(!currentBuffer.shouldDrain && vlcPlayer.State != VLCState.Stopped) 
                CreateNewBuffer();
        }
