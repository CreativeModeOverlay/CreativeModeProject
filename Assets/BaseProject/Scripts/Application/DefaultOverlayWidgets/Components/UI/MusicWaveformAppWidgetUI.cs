...
namespace CreativeMode
{
    public class MusicWaveformAppWidgetUI : BaseAppWidgetUI<MusicWaveformAppWidget>
    {
        ...
        [Header("Waveform")] public AudioChannel channel = AudioChannel.Center;
        public int sampleCount = 512;
        public float scaleMin;
        public float scaleMax;
        public float scaleFadeSpeed;

        [Header("Display")] public RectOffset padding;
        ...
        private void UpdateSamples()
        {
            ...
            {
                accumulatedSamples[i] = Mathf.Clamp((accumulatedSamples[i] - adaptiveScaleOffset) / adaptiveScaleValue,
                    -1f, 1f);
            }
        }
