...
namespace CreativeMode
{
    public class SongLyricsAppWidgetUI : BaseAppWidgetUI<SongLyricsAppWidget>
    {
        ...
        [Header("Visuals")] public Text voiceText;
        ...
        private void AddNewLyricLine(SongLyrics.Line line)
        {
            ...
            {
                case SongLyrics.Line.Position.Left:
                    instance.alignment = TextAnchor.UpperLeft;
                    break;
                case SongLyrics.Line.Position.Center:
                    instance.alignment = TextAnchor.UpperCenter;
                    break;
                case SongLyrics.Line.Position.Right:
                    instance.alignment = TextAnchor.UpperRight;
                    break;
            }
