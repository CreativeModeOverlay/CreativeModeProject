...
{
    public class AppWidgetUIPanel : MonoBehaviour
    {
        ...
        public AppWidgetUIContainer uiContainerPrefab;
        ...
        private void OnWidgetUpdated(AppWidgetData widget)
        {
            for (var i = 0; i < currentContainers.Count; i++)
            {
                var container = currentContainers[i];
                if (container.widgetId == widget.id)
                    container.container.SetData(widget.data);
            }
        }

        private void OnListUpdated(IReadOnlyList<AppWidgetPanel.Widget> newList)
        {
        ...
        private ContainerInfo CreateContainer(AppWidgetPanel.Widget p)
        {
            ...
            container.widgetRenderer.Data = widgetData.data;
        ...
        private void AnimateAppear(AppWidgetUIContainer container, Rect targetPosition, float offset)
        {
            var rectTransform = (RectTransform) container.transform;
        ...
        private void AnimateMove(AppWidgetUIContainer container, Rect targetPosition, float offset)
        {
            var rectTransform = (RectTransform) container.transform;
        ...
        private void AnimateRemove(AppWidgetUIContainer container, float offset)
        {
            var rectTransform = (RectTransform) container.transform;
        ...
        private class ContainerInfo : WidgetPanelLayout.IWidget
        {
            ...
            public AppWidgetUIContainer container;

            public UIContentSize Size => container.Size;
