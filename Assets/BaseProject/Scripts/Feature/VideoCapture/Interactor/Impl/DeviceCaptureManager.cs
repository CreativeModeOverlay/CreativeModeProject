...
{
    internal class DeviceCaptureManager : MonoBehaviour, IDeviceCaptureManager
    {
        ...
        private Dictionary<string, IObservable<CapturedVideo>> activeCaptureTextures 
            = new Dictionary<string, IObservable<CapturedVideo>>();
        ...
        public void SetCaptureParams(string deviceName, VideoCaptureParams captureParams)
        {
        ...
        public VideoCaptureParams GetCaptureParams(string deviceName)
        {
            ...
            return new VideoCaptureParams { resolution = resolution };
        }

        public IObservable<CapturedVideo> CaptureDevice(string deviceName)
        {
        ...
        private class CaptureInfo
        {
            ...
            public CapturedVideo Update(DeviceCaptureManager manager, VideoCaptureParams captureParams)
            {
